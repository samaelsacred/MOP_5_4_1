...
enum Opcodes
{
    ...
    CMSG_CHAR_CREATE                                         = 0x08CD,
    CMSG_CHAR_CUSTOMIZE                                      = 0x0,
    CMSG_CHAR_DELETE                                         = 0x09C0,
    CMSG_CHAR_ENUM                                           = 0x0848,
    ...
    CMSG_DEL_FRIEND                                          = 0x1909,
    CMSG_DEL_IGNORE                                          = 0x0901,
    ...
    CMSG_GOSSIP_HELLO                                        = 0x025C,
    CMSG_GOSSIP_SELECT_OPTION                                = 0x03EE,
    ...
    CMSG_LOAD_SCREEN                                         = 0x1148,
    CMSG_LOGOUT_CANCEL                                       = 0x0A7E,
    CMSG_LOGOUT_REQUEST                                      = 0x03EC,
    CMSG_LOG_DISCONNECT                                      = 0x14FA,
    CMSG_LOOT                                                = 0x0,
    ...
    CMSG_OBJECT_UPDATE_FAILED                                = 0x1A44,
    ...
    CMSG_RANDOMIZE_CHAR_NAME                                 = 0x184C,
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES                        = 0x144C,
    CMSG_READ_ITEM                                           = 0x0,
    CMSG_REALM_SPLIT                                         = 0x0449,
    CMSG_REALM_NAME_QUERY                                    = 0x09E1,
    ...
    CMSG_RETURN_TO_GRAVEYARD                                 = 0xA65,
    ...
    CMSG_TEXT_EMOTE                                          = 0x0CDC,
    CMSG_TIME_ADJUSTMENT_RESPONSE                            = 0x0,
    CMSG_TIME_SYNC_RESP                                      = 0x0341,
    CMSG_TIME_SYNC_RESP_FAILED                               = 0x0,
    CMSG_TOGGLE_PVP                                          = 0x12C6,
    ...
    CMSG_WARDEN_DATA                                         = 0x05E8,
    CMSG_WARGAME_ACCEPT                                      = 0x0,
    CMSG_WARGAME_START                                       = 0x0,
    CMSG_WHO                                                 = 0x1568,
    CMSG_WHOIS                                               = 0x5480,
    CMSG_WORLD_STATE_UI_TIMER_UPDATE                         = 0x04EC,
    ...
    MSG_MOVE_CLICK_TO_MOVE                                   = 0x1368,
    MSG_MOVE_FALL_LAND                                       = 0x17E9,
    MSG_MOVE_HEARTBEAT                                       = 0x0AC8,
    MSG_MOVE_JUMP                                            = 0x07C9,
    MSG_MOVE_SET_ALL_SPEED_CHEAT                             = 0x0,
    MSG_MOVE_SET_COLLISION_HEIGHT                            = 0x0,
    MSG_MOVE_SET_FACING                                      = 0x1368,
    MSG_MOVE_SET_FLIGHT_SPEED_CHEAT                          = 0x0,
    MSG_MOVE_SET_PITCH                                       = 0x0261,
    MSG_MOVE_SET_RAW_POSITION_ACK                            = 0x0,
    MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT                        = 0x0,
    MSG_MOVE_SET_RUN_MODE                                    = 0x0748,
    ...
    MSG_MOVE_SET_WALK_MODE                                   = 0x0BE1,
    MSG_MOVE_SET_WALK_SPEED_CHEAT                            = 0x0,
    MSG_MOVE_START_ASCEND                                    = 0x16C1,
    MSG_MOVE_START_BACKWARD                                  = 0x12C0,
    MSG_MOVE_START_DESCEND                                   = 0x0641,
    MSG_MOVE_START_FORWARD                                   = 0x13C9,
    MSG_MOVE_START_PITCH_DOWN                                = 0x16E8,
    MSG_MOVE_START_PITCH_UP                                  = 0x0FE1,
    MSG_MOVE_START_STRAFE_LEFT                               = 0x0EC8,
    MSG_MOVE_START_STRAFE_RIGHT                              = 0x0269,
    MSG_MOVE_START_SWIM                                      = 0x0FC8,
    MSG_MOVE_START_TURN_LEFT                                 = 0x0760,
    MSG_MOVE_START_TURN_RIGHT                                = 0x17C9,
    MSG_MOVE_STOP                                            = 0x0649,
    MSG_MOVE_STOP_ASCEND                                     = 0x1268,
    MSG_MOVE_STOP_PITCH                                      = 0x1A48,
    MSG_MOVE_STOP_STRAFE                                     = 0x12C9,
    MSG_MOVE_STOP_SWIM                                       = 0x0FC9,
    MSG_MOVE_STOP_TURN                                       = 0x1749,
    MSG_MOVE_TELEPORT                                        = 0x0A2E,
    ...
    MSG_MOVE_WORLDPORT_ACK                                   = 0x00E0, // Is this right?
    ...
    SMSG_ACCOUNT_DATA_TIMES                                  = 0x1486,
    ...
    SMSG_ADDON_INFO                                          = 0x1136,
    SMSG_ADD_RUNE_POWER                                      = 0x0,
    SMSG_AI_REACTION                                         = 0x0,
    SMSG_ALL_ACHIEVEMENT_DATA                                = 0x0005,
    ...
    SMSG_ATTACKERSTATEUPDATE                                 = 0x182B,
    SMSG_ATTACKSTART                                         = 0x012F,
    SMSG_ATTACKSTOP                                          = 0x0D3C,
    ...
    SMSG_CHANNEL_NOTIFY                                      = 0x1490,
    SMSG_CHARACTER_LOGIN_FAILED                              = 0x0,
    SMSG_CHAR_CREATE                                         = 0x1007,
    SMSG_CHAR_CUSTOMIZE                                      = 0x0,
    SMSG_CHAR_DELETE                                         = 0x0017,
    SMSG_CHAR_ENUM                                           = 0x040E,
    ...
    SMSG_CLIENTCACHE_VERSION                                 = 0x1037,
    ...
    SMSG_EQUIPMENT_SET_LIST                                  = 0x0CBF,
    ...
    SMSG_FEATURE_SYSTEM_STATUS                               = 0x142C,
    ...
    SMSG_HEALTH_UPDATE                                       = 0x0C36,
    SMSG_HIGHEST_THREAT_UPDATE                               = 0x0,
    SMSG_HOTFIX_INFO                                         = 0x0C27,
    SMSG_HOTFIX_NOTIFY                                       = 0x0,
    SMSG_INITIALIZE_FACTIONS                                 = 0x0CAC,
    SMSG_INITIAL_SPELLS                                      = 0x1164,
    SMSG_INIT_CURRENCY                                       = 0x08AC,
    SMSG_INIT_WORLD_STATES                                   = 0x0D94,
    SMSG_INSPECT                                             = 0x0,
    ...
    SMSG_MESSAGECHAT                                         = 0x14AC,
    SMSG_MESSAGE_BOX                                         = 0x142D,
    ...
    SMSG_QUEST_QUERY_RESPONSE                                = 0x0B5C,
    ...
    SMSG_RESISTLOG                                           = 0x0,
    SMSG_RESPOND_INSPECT_ACHIEVEMENTS                        = 0x04AF,
    ...
    SMSG_SEND_UNLEARN_SPELLS                                 = 0x14C4,
    SMSG_SERVERTIME                                          = 0x0,
    ...
    SMSG_SUSPEND_TOKEN_RESPONSE                              = 0x0496,
    SMSG_TALENTS_ERROR                                       = 0x0,
    SMSG_TALENTS_INFO                                        = 0x0494,
    ...
    SMSG_TRIGGER_CINEMATIC                                   = 0x0198,
    SMSG_TRIGGER_MOVIE                                       = 0x0,
    SMSG_TURN_IN_PETITION_RESULTS                            = 0x0,
    SMSG_TUTORIAL_FLAGS                                      = 0x0D1B,
